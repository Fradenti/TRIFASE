...
// [[Rcpp::export]]
Rcpp::List AlgoAll_cpp(arma::mat X,
                     arma::mat Fm,
                     arma::mat Gm,
                     arma::mat L,
                     arma::mat Linv,
  ...
  for(int i =0; i<niter; i++){
    ...
    if(i>0){
      ...
      if( abs(loss(i)-loss(i-1)) < threshold ){ 
...
// [[Rcpp::export]]
Rcpp::List Algo4_cpp(arma::mat X,
                     arma::mat Fm,
                     arma::mat Gm,
                     arma::mat L,
                     arma::mat Linv,
...
// [[Rcpp::export]]
Rcpp::List AlgoAll_cpp2(arma::mat X,
                       arma::mat Fm,
                       arma::mat Gm,
                       arma::mat L,
                       arma::mat iKernel, 
